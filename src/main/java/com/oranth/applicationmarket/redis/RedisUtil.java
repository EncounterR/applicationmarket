...
//		FastJson2JsonRedisSerializer<Object> serializer = new FastJson2JsonRedisSerializer<Object>();
//		RedisSerializer serializer = new GenericToStringSerializer(Object.class);		
//		this.redisTemplate.setDefaultSerializer(serializer);
//		this.redisTemplate.setStringSerializer(null);
...
//		this.redisTemplate.setHashKeySerializer(serializer);
	...
	String prefix = "*";
	/**
	 * 删除以 prefix开头的所有缓存，prefix为空 则删除所有
	 * @param prefix
	 * @return
	 */
	public long delAll(String prefix){
		if(!Util.isEmpty(prefix)){
			this.prefix += prefix;
		}
		Set<Object> keys = getAll(prefix);
	 ...
	 * @return
	 */
	public Set<Object> getAll(String prefix){
 ...
 * 具体的改造过程示例：
 */
/*	public boolean set_old(String key,Object value,int indexdb) {
		try {
			redisTemplate.indexdb.set(indexdb);
			redisTemplate.opsForValue().set(key, value);
			return true;
